  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative bg-hero-bg overflow-hidden">
        ...
        <div className="absolute right-0 top-0 h-full w-full lg:w-[60%] z-0">
          <Image
            src={heroFamily}
        ...
        <div className="relative z-10 mx-auto max-w-[1440px] px-10 pt-20 pb-28">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-10 items-center min-h-[500px]">
            {/* Left */}
            <div className="max-w-[620px] relative z-20">
              ...
              <div className="mt-10 flex flex-wrap gap-4">
                <button className="inline-flex items-center gap-3 rounded-md bg-navy px-7 py-4 text-[16px] font-semibold text-navy-foreground hover:bg-navy/90 transition-colors">
                ...
                <button className="inline-flex items-center gap-3 rounded-md border border-navy bg-white px-7 py-4 text-[16px] font-semibold text-navy hover:bg-muted transition-colors">
                  <PlayCircle className="h-6 w-6" strokeWidth={1.5} />
                  How It Works
                </button>
              </div>
              <div className="mt-10 flex flex-wrap items-center gap-6 text-[14px] font-medium text-navy">
                <div className="flex items-center gap-2"><ShieldCheck className="h-5 w-5 text-teal" /> Independent advice</div>
                <div className="h-4 w-px bg-navy/20"></div>
      ...
      <section className="border-b border-border bg-white relative z-20">
        <div className="mx-auto grid max-w-[1440px] grid-cols-2 items-center justify-between gap-8 px-10 py-8 md:grid-cols-3 lg:flex lg:flex-nowrap">
